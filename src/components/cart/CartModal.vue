        ...
        >
            ...
            <div class="wrapper-price">
              ...
              <div class="price-info">
                <div class="price">{{ FloatToMoney(item.totalPrice * item.quantity) }}</div>
        ...
        <div class="wrapper-delivery">
          ...
          <div class="cost-summary">
            <div>
              ...
              <span>{{ FloatToMoney(cartStore.subtotal) }}</span>
            </div>
            <div>
            ...
            <div class="total">
              <strong>Total</strong>
              <strong>{{ FloatToMoney(cartStore.subtotal + serviceFee + deliveryFee) }}</strong>
            </div>
          </div>
          <Button 
            class="checkout-btn"
